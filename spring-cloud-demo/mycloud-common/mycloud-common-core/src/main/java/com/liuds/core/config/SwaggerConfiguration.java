package com.liuds.core.config;

import com.liuds.config.properties.MycloudProperties;
import com.liuds.config.properties.SwaggerProperties;
 ...
 */
//@EnableSwagger2
@Import(MycloudProperties.class)
public class SwaggerConfiguration {
	@Resource
	private MycloudProperties mycloudProperties;
...
//				.globalOperationParameters(pars)
	...
	private ApiInfo apiInfo() {
		SwaggerProperties swagger = mycloudProperties.getSwagger();
